			...
			<div class="row">
				...
				<div class="col-lg-5 order-1 order-lg-2 contact-text text-white">
					...
					<div class="cont-info">
						...
						<div class="ci-text">AXSOS, Abu_Shkhadam, Ramallah</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon">
							<img src="img/icons/phone.png" alt="">
						</div>
						<div class="ci-text">+972 597276 032</div>
					</div>
					<div class="cont-info">
						<div class="ci-icon">
							<img src="img/icons/mail.png" alt="">
						</div>
						<div class="ci-text">abdullah.z.qasem@gmail.com</div>
					</div>
				</div>
			</div>
		</div>
