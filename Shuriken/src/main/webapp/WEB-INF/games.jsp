...
<body>
	...
	<header class="header-section">
		...
		<input type="hidden" name="${_csrf.parameterName}"
			value="${_csrf.token}" /> <input  class="btn btn-secondary" type="submit" value="Logout!" />
	</form>
					</div>
					<!-- Menu -->
	...
	<section class="games-single-page">
		<div class="container">
			...
			<button class="site-btn">
				Download connection file <img src="img/icons/double-arrow.png"
					alt="#" />
			</button>
			<p class="site-btn">
				your password : %wpy-k;A2KsLLpg*83--qk9cYU)PB5pW <img
					src="img/icons/double-arrow.png" />
			</p>
			<!-- <div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					<div class="gs-meta">11.11.18  /  in <a href="/games">Games</a></div>
